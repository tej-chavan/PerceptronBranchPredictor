...
enum bpred_class {
  ...
  BPredPerceptron,   /*Neural Network perceptron Branch predictor*/
  BPred_NUM
};
...
struct bpred_dir_t {
  ...
  union {
    ...
    /*--------------------------------------------------------------------------------------*/
    /*                      STRUCTURE FOR PERCEPTRON PREDICTOR MODEL                        */
    /*--------------------------------------------------------------------------------------*/
    struct {
       int wt_entries;                                        // Number of entries in the WEight table .  Will be passed as an argument by the user from 'l1size'
